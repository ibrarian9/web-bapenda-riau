...
Route::prefix('wajib-pajak')->name('wajib.pajak')->group(function () {
    ...
    Route::get('/kendaraan/{kendaraanId}/detail', [WajibPajakController::class, 'detailKendaraan'])
        ->name('.kendaraan.detail');
    Route::get('/kendaraan/{kendaraanId}/pajak', [WajibPajakController::class, 'detailPajak'])
        ->name('.kendaraan.pajak');
});
